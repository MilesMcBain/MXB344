...
$$Pr(P = p) = \frac{1}{n}{n\choose np}\pi^{np}(1-\pi)^{1-y}$$
...
* This is alo related to the historical use of logistic models as predictive models. In industry they tend to be assessed on their predictive accuracy.
