...
#Removing Very high
project_data <-
  project_data %>% select(-mths_since_last_major_derog, -mths_since_last_record, -next_pymnt_d)
...
project_data <-
  project_data %>% select(-recoveries, -grade, -loan_status, -sub_grade, -installment)
```
